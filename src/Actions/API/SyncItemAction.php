...
class SyncItemAction
{
    ...
    public function execute(
        ...
        try {
            ...
            Log::error('Failed to sync item to Exact Online', [
    ...
    protected function create(
        ...
        $createAction = Config::getAction('create_item', CreateItemAction::class);
        ...
        ItemSynced::dispatch($connection, $model, $result);
    ...
    protected function update(
        ...
        $updateAction = Config::getAction('update_item', UpdateItemAction::class);
        ...
        Log::info('Updated item in Exact', [
            'connection_id' => $connection->id,
            'model_type' => get_class($model),
            'model_id' => $model->getKey(),
            'exact_id' => $exactId,
